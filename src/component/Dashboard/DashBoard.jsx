        ...
        <>
            <div className='container-fluid'>
                <div className="d-flex py-3">
                    <div className='col-6 '>
                        <h5 >Good Morning, Rudra</h5>
                        <p className='m-0'>Here's what's happening with your store today.</p>
                    </div>
                    <div className='col-6 d-flex py-2 justify-content-end align-items-center'>
                        <div className='calendar d-flex mx-2'>
                            <div className='w-10 bg-white shadow-sm p-2 rounded-start'>
                                <DatePicker range dateSeparator=" to " />
                            </div>
                            <div className='w-4 bg-primary text-white p-2 rounded-end'>
                                <Calendar3 />
                            </div>
                        </div>
                        <div className='cta-btn mx-2'>
                            <div className=''>
                        ...
                        <div className='recentActivity mx-2'>
